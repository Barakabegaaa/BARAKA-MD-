...
zokou({
  ...
  if (!arg[0]) {
    repondre("wrong!!! Ie. _Play hozambe by Baraka ft shifura._");
    return;
  }
...
\n\n\n ©𝐌𝐫 𝐛𝐚𝐫𝐚𝐤𝐚`
      ...
      fileStream.on('finish', () => {
        ...
        zk.sendMessage(origineMessage, { video: { url :"./video.mp4"} , caption: "©𝐌𝐫 𝐛𝐚𝐫𝐚𝐤𝐚", gifPlayback: false }, { quoted: ms });
      });
